  ...
  return (
    <>
      <Box color="inherit" m={0} p={0} className={isMobile ? "block" : "flex"}>
        ...
        <NavbarLink icon="people" name={t('navbar.sign-in')} route="https://console.my-portfolio.it/auth/sign-in" light={light} closeMobileNavbar={closeMobileNavbar} />
        <NavbarLink icon="account_circle" name={t('navbar.sign-up')} route="https://console.my-portfolio.it/auth/sign-up" light={light} closeMobileNavbar={closeMobileNavbar} />
        <NavbarLink icon="volunteer_activism" name={t('navbar.support')} route="/support" light={light} closeMobileNavbar={closeMobileNavbar} />
      </Box>
      <Box >
